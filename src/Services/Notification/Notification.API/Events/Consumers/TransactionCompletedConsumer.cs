...
public class TransactionCompletedConsumer : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var queueName = $"{RabbitMQQueues.TransactionCompleted}.notifications";
        ...
        _logger.LogInformation("Notification TransactionCompletedConsumer started");
    ...
    private async Task OnMessageReceived(object sender, BasicDeliverEventArgs args)
    {
        ...
        try
        {
            ...
            await notificationService.SendAsync(
                ...
                placeholders:   new Dictionary<string, string>
                {
                    ...
                    { "Points",        "0" }  // updated when PointsAwarded event arrives
                });
        ...
        {
            _logger.LogError(ex, "Error in Notification TransactionCompletedConsumer");
